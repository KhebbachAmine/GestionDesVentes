...
<form action="<?php echo e(route('etudiants.ajouteretudiant')); ?>" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group col-md-6">
      ...
      <input type="date" class="form-control" name="naissance" value="<?php echo e(old('naissance')); ?>"  placeholder="Date de naissance">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LARAVEL\GestionDesVentes\resources\views/etudiants/afficheretudiant.blade.php ENDPATH**/ ?>