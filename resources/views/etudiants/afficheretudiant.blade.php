...
<form action="{{ route('etudiants.ajouteretudiant')}}" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group col-md-6">
      ...
      <input type="date" class="form-control" name="naissance" value="{{ old('naissance') }}"  placeholder="Date de naissance">
